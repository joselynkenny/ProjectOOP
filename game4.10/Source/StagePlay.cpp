...
game_framework::StagePlay::StagePlay(int files)
{
...
game_framework::StagePlay::~StagePlay()
{
	WriteBack();
}

void game_framework::StagePlay::LoadStage()
{
	fstream InputStage;
...
double game_framework::StagePlay::GetScoreOne()
{
	return scoreOne;
}

double game_framework::StagePlay::GetScoreTwo()
{
	return scoreTwo;
}

double game_framework::StagePlay::GetScoreThree()
{
	return scoreThree;
}
double game_framework::StagePlay::GetLastScoreHistory()
{
	return lastHighScore;
}
bool game_framework::StagePlay::IsUnlock()
{
	return isUnlock == 1 ? true : false;
}
bool game_framework::StagePlay::IsFail()
{
	return isFail;
}
void game_framework::StagePlay::SetPassOrFail(int fail)
{
	isFail = fail == 1 ? 1 : 0;
}
int game_framework::StagePlay::GetCurrentScore()
{
	return currentScore;
}
int game_framework::StagePlay::GetCurrentStage()
{
	return currentStage;
}
...
void game_framework::StagePlay::RemoveLine()
{
...
void game_framework::StagePlay::WriteBack()
{
	RemoveLine();
...
void game_framework::StagePlay::SetCurrentScore(int score)
{
	currentScore = score;
}

void game_framework::StagePlay::SetUnlock()
{
	isUnlock = true;
}
